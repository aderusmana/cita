                            ...
                            <tr>
                                        ...
                                        <div class="ms-3">
                                            <div class="user-meta-info">
                                                <h6 class="user-name mb-0" data-name="{{ $user->name }}">
                                                    {{ $user->name }}</h6>
                                                <span class="user-nik fs-3"
                                                    data-nik="{{ $user->nik }}">{{ $user->nik }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <span class="usr-email-addr"
                                        data-email="{{ $user->email }}">{{ $user->email }}</span>
                                </td>
                                <td>
                                    <span class="usr-department"
                                        data-department-id="{{ $user->department->id }}">{{ $user->department->name }}</span>
                                </td>
                                <td>
                                    <span class="usr-position"
                                        data-position-id="{{ $user->position->id }}">{{ $user->position->name }}</span>
                                </td>
                                <td>
                                    <span class="usr-section"
                                        data-section-id="{{ $user->section->id }}">{{ $user->section->name }}</span>
                                </td>
